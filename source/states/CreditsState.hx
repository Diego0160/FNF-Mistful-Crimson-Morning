	...
	override function update(elapsed:Float)
	{
		...
		if(!quitting)
		{
			...
			if (controls.BACK)
			{
				...
				// Efecto de salida: zoom desde 1 hasta 0.5 con desvanecimiento
        		Transition.exitState(0.5, 0.7, function()
        			{
            			Transition.zoomOut("credits", function() {
                		Transition.fromState = "credits";
