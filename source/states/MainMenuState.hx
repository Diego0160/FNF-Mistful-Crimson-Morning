...
class MainMenuState extends MusicBeatState
{
    ...
    override function create()
    {
        ...
        if (LoadingState.fromState != "main") {
            FlxG.camera.zoom = 0.8;
            LoadingState.zoomIn();
        } else {
            LoadingState.resetZoom();
        }
    }
        ...
        if (!selectedSomethin)
        {
            ...
            if (controls.BACK)
            {
                ...
                FlxG.sound.music.fadeOut(0.5, 0, function(twn:flixel.tweens.FlxTween) {
                    ...
                    LoadingState.zoomOut("MainMenuState", function() {
                        LoadingState.fromState = "MainMenuState";
            ...
            if (controls.ACCEPT)
            {
                ...
                LoadingState.zoomOut("main", function()
                {
